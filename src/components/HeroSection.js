      ...
      <div className="container col-xxl-8 px-4 py-5">
        <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
          ...
          <div className="col-lg-6">
            ...
            <p className="lead">
            I am an adept full-stack web developer skilled in front-end and back-end technologies, proficient in HTML, CSS, JavaScript, and server-side languages like Node.js, Python, or Ruby. My expertise spans responsive, dynamic web applications, and excels in problem-solving and adapting to evolving tech environments, making you a valuable asset in web development.
            </p>
